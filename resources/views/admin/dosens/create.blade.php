...
@section('breadcrumb')
    ...
    <span class="mx-2 text-gray-400">/</span>
    <span class="text-gray-900">Tambah Dosen Baru</span>
@endsection
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Tambah Dosen Baru</h2>
            <p class="text-gray-600">Tambahkan data dosen baru ke dalam database</p>
        </div>
        ...
        <form action="{{ route('admin.dosens.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <select id="prodi" 
                    ...
                    <option value="S1 Digital Supply Chain" {{ old('prodi') === 'S1 Digital Supply Chain' ? 'selected' : '' }}>S1 Digital Supply Chain</option>
                    <option value="S1 Manajemen Rekayasa" {{ old('prodi') === 'S1 Manajemen Rekayasa' ? 'selected' : '' }}>S1 Manajemen Rekayasa</option>
                    <option value="S2 Sistem Informasi" {{ old('prodi') === 'S2 Sistem Informasi' ? 'selected' : '' }}>S2 Sistem Informasi</option>
                    <option value="S2 Teknik Industri" {{ old('prodi') === 'S2 Teknik Industri' ? 'selected' : '' }}>S2 Teknik Industri</option>
                </select>
