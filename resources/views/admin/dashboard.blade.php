...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 bg-gradient-to-r from-green-600 to-green-700 flex items-center justify-between">
            ...
            <a href="{{ route('admin.verifikasi-pengajuan') }}" class="text-white hover:text-green-100 text-sm font-medium flex items-center gap-1">
                Lihat Semua
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <a href="{{ route('admin.users') }}" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition group">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 group-hover:text-green-600 transition">Manajemen User</h3>
                    <p class="text-sm text-gray-600">Kelola user admin dan mahasiswa</p>
                </div>
            </div>
        </a>
        <a href="{{ route('admin.periodes') }}" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition group">
            <div class="flex items-center gap-4">
                <div class="w-16 h-16 bg-green-100 rounded-lg flex items-center justify-center group-hover:bg-green-200 transition">
                    <svg class="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 group-hover:text-green-600 transition">Manajemen Periode</h3>
                    <p class="text-sm text-gray-600">Kelola periode pengajuan dan verifikasi yudisium</p>
                </div>
            </div>
        </a>
        <a href="{{ route('admin.yudisium-sidings') }}" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition group">
            <div class="flex items-center gap-4">
                <div class="w-16 h-16 bg-green-100 rounded-lg flex items-center justify-center group-hover:bg-green-200 transition">
                    <svg class="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900 group-hover:text-green-600 transition">Sidang Yudisium</h3>
                    <p class="text-sm text-gray-600">Kelola data sidang yudisium mahasiswa yang sudah approved</p>
                </div>
            </div>
        </a>
    </div>
