...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <div class="mb-6">
            ...
            <p class="text-gray-600">Perbarui informasi user dan role</p>
        </div>
        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST" id="edit-user-form">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <label class="relative cursor-pointer">
                        <input type="radio" name="role" value="admin" class="sr-only peer" onchange="toggleStudentFields()" {{ $user->role === 'admin' ? 'checked' : '' }} required>
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="role" value="student" class="sr-only peer" onchange="toggleStudentFields()" {{ $user->role === 'student' ? 'checked' : '' }} required>
                        <div class="p-4 border-2 border-gray-200 rounded-lg peer-checked:border-green-600 peer-checked:bg-green-50 transition">
                            <div class="flex items-center gap-3">
            ...
            <div id="student-fields" class="{{ $user->role === 'student' ? '' : 'hidden' }} border-t border-gray-200 pt-6 mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="prodi" 
                            ...
                            type="text" 
                            name="prodi" 
                            :value="old('prodi', $user->student->prodi ?? '')"
                    ...
                    <div>
                        ...
                        <x-text-input id="ipk" 
                            ...
                            min="0"
                            max="4"
                            :value="old('ipk', $user->student->ipk ?? '')"
                            placeholder="3.75" />
                    ...
                    <div>
                        ...
                        <x-text-input id="total_sks" 
                            ...
                            name="total_sks" 
                            min="0"
                            :value="old('total_sks', $user->student->total_sks ?? '')"
                            placeholder="144" />
                    ...
                    <div>
                        ...
                        <x-text-input id="tak" 
                            ...
                            name="tak" 
                            min="0"
                            :value="old('tak', $user->student->tak ?? '')"
                            placeholder="120" />
                        <x-input-error :messages="$errors->get('tak')" class="mt-2" />
                    </div>
                </div>
            </div>
