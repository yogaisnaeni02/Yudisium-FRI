...
@section('title', 'Edit Informasi Yudisium')
@section('page-title', 'Edit Informasi Yudisium')
...
@section('breadcrumb')
    ...
    <span class="mx-2 text-gray-400">/</span>
    <span class="text-gray-900">Edit Informasi</span>
@endsection
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Edit Informasi Yudisium</h2>
            <p class="text-gray-600">Perbarui informasi yudisium</p>
        </div>
        ...
        <form action="{{ route('admin.articles.update', $article) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea id="excerpt" 
                    ...
                    rows="3"
                    class="block mt-1 w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-lg"
                    placeholder="Ringkasan singkat informasi (opsional)">{{ old('excerpt', $article->excerpt) }}</textarea>
            ...
            <div class="mb-6">
                ...
                <textarea id="content" 
                    ...
                    class="block mt-1 w-full border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-lg"
                    required
                    placeholder="Tulis isi informasi di sini...">{{ old('content', $article->content) }}</textarea>
            ...
            <div class="mb-6">
                ...
                @if($article->image)
                <div class="mb-3">
                    <img src="{{ asset('storage/' . $article->image) }}" alt="Current image" class="max-w-xs rounded-lg border border-gray-300">
            ...
            <div class="flex items-center justify-end gap-4 mt-8 pt-6 border-t border-gray-200">
                <x-button variant="ghost" href="{{ route('admin.articles') }}">
                    Batal
                </x-button>
