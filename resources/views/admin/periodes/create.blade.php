...
@section('page-title', 'Tambah Periode Yudisium')
...
@section('breadcrumb')
    ...
    <span class="mx-2 text-gray-400">/</span>
    <span class="text-gray-900">Tambah Periode</span>
@endsection

@section('content')
<div class="space-y-6">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">Buat Periode Baru</h2>
        
        <form action="{{ route('admin.periodes.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="flex gap-3 pt-4">
                ...
                <x-button variant="ghost" href="{{ route('admin.periodes') }}" icon='<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>'>
                    Batal
                </x-button>
            </div>
        </form>
