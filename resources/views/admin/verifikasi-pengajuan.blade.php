...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <form method="GET" action="{{ route('admin.verifikasi-pengajuan') }}" class="flex flex-col md:flex-row gap-3">
            ...
            <!-- Reset Button -->
            @if($search)
            <a href="{{ route('admin.verifikasi-pengajuan', ['view' => $viewType, 'sort' => $sort]) }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-2.5 px-6 rounded-lg transition whitespace-nowrap flex items-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
