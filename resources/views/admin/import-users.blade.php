    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r mb-6">
            ...
            <div class="bg-white p-4 rounded-lg border border-blue-200 mb-4">
                <code class="text-sm text-gray-800">name,email,password,role,nim,nama,ipk,total_sks</code>
            </div>
        ...
        <div class="bg-gray-50 border border-gray-200 p-6 rounded-lg mb-6">
            ...
            <div class="bg-white p-4 rounded border border-gray-300 overflow-x-auto">
                <pre class="text-xs text-gray-700">name,email,password,role,nim,nama,ipk,total_sks
John Doe,john@example.com,password123,student,123456789,John Doe,3.75,144
Jane Smith,jane@example.com,password123,student,987654321,Jane Smith,3.80,144
Admin User,admin@example.com,password123,admin,,,,
        ...
        <form action="{{ route('admin.users.import.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex items-center justify-end gap-4 mt-8 pt-6 border-t border-gray-200">
                ...
                <button type="submit" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-2.5 px-6 rounded-lg transition shadow-lg hover:shadow-xl flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
