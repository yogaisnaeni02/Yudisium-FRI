...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex items-center justify-between">
        ...
        <a href="{{ route('admin.yudisium-sidings.create') }}" class="bg-green-600 hover:bg-green-700 text-white font-semibold py-2.5 px-6 rounded-lg transition shadow-sm hover:shadow flex items-center gap-2">
        ...
        <form method="GET" action="{{ route('admin.yudisium-sidings') }}" class="flex flex-wrap gap-4">
            ...
            <div class="flex items-end">
                ...
                @if($search || $periodeFilter)
                    <a href="{{ route('admin.yudisium-sidings') }}" class="ml-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-2 px-6 rounded-lg transition">
                        Reset
                    </a>
                @endif
            </div>
                    ...
                    @forelse($sidings as $siding)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                <a href="{{ route('admin.yudisium-sidings.show', $siding) }}" 
                                    class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-lg transition shadow-sm hover:shadow">
                                ...
                                <a href="{{ route('admin.yudisium-sidings.edit', $siding) }}" 
                                    class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-lg transition shadow-sm hover:shadow">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
