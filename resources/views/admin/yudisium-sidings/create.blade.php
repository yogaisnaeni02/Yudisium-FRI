...
@section('title', 'Tambah Sidang Yudisium')
@section('page-title', 'Tambah Data Sidang Yudisium')
...
@section('content')
<div class="space-y-6">
    <form action="{{ route('admin.yudisium-sidings.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="tanggal_sidang" value="{{ old('tanggal_sidang') }}" required
                ...
                <div>
                    ...
                    <select name="status_yudisium" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                        <option value="pending" {{ old('status_yudisium') == 'pending' ? 'selected' : '' }}>Pending</option>
                        <option value="lulus" {{ old('status_yudisium') == 'lulus' ? 'selected' : '' }}>Lulus</option>
                        <option value="tidak_lulus" {{ old('status_yudisium') == 'tidak_lulus' ? 'selected' : '' }}>Tidak Lulus</option>
                    </select>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" max="100" name="pembimbing_1_nilai" value="{{ old('pembimbing_1_nilai') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>
                </div>
                <!-- Pembimbing 2 -->
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" max="100" name="pembimbing_2_nilai" value="{{ old('pembimbing_2_nilai') }}"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="penguji_ketua_nilai" value="{{ old('penguji_ketua_nilai') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="penguji_anggota_nilai" value="{{ old('penguji_anggota_nilai') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
            </div>
        </div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <textarea name="judul_tugas_akhir" rows="3"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">{{ old('judul_tugas_akhir') }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Jenis Tugas Akhir</label>
                    <input type="text" name="jenis_tugas_akhir" value="{{ old('jenis_tugas_akhir') }}" placeholder="Contoh: Sidang"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="nilai_total" value="{{ old('nilai_total') }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Nilai Huruf</label>
                    <input type="text" name="nilai_huruf" value="{{ old('nilai_huruf') }}" placeholder="Contoh: AB, A, B"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Predikat Yudisium</label>
                    <input type="text" name="predikat_yudisium" value="{{ old('predikat_yudisium') }}" placeholder="Contoh: SANGAT MEMUASKAN"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                </div>
                <div>
                    ...
                    <select name="status_cumlaude" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                        ...
                        <option value="cumlaude" {{ old('status_cumlaude') == 'cumlaude' ? 'selected' : '' }}>Cumlaude</option>
                        <option value="summa_cumlaude" {{ old('status_cumlaude') == 'summa_cumlaude' ? 'selected' : '' }}>Summa Cumlaude</option>
                    </select>
                </div>
                <div class="md:col-span-2">
                    ...
                    <textarea name="pemenuhan_jurnal" rows="2"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">{{ old('pemenuhan_jurnal') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-end gap-4">
            <a href="{{ route('admin.yudisium-sidings') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-2.5 px-6 rounded-lg transition">
                Batal
            </a>
